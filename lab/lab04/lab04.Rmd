...
### Instructions 
* Due date: Tuesday, July 20 at 10:00pm PST with 2 hour grace period.
...
implies that the disease is rare, but a very accurate test exists for the disease (i.e., 
equally high sensitivity and specificity).

**1. Fill in the following two-way table with the absolute frequencies provided in the problem. (You can fill it in simply by typing the frequencies in the nine empty cells.):**
...
**2. Calculate the PPV (Positive Predictive Value) using the entries from your table.**
...
**4. Again, calculate the PPV (Positive predictive value) using the entries from your table. **
...
**8. Calculate the marginal probability of CHD. This can be written as $P(D)$. Store it in the variable p8 rounded to the nearest whole number percentage.**
...
cd; cd ph142-su21/lab/lab04; python3 turn_in.py
