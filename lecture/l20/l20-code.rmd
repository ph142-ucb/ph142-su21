...
### Skipping around
To stick with continuous outcomes, we are going to skip ahead to chapter 24 (ANOVA) and chapter 23(regression)
and bring in some outside information about non-parametric testing.

### Summary of Continouous outcomes so far - Z and the flavors of T
...
```{r tukey, fig.align='center',out.width="60%",echo=FALSE }
