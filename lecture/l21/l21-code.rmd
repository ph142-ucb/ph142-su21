...
from Wrona, R.M., "A Clinical Epidemiologic Study of Hyperphenylalaninemia," American Journal of Public Health, volume 69, July 1979, 673-679.
...
###note kruskal.test will also take syntax kruskal.test(group1,group2,group3)

```

### Non parametric summary

Most parametric tests have an analagous non-parametric test
